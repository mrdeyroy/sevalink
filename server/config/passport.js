...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
        ...
        new GoogleStrategy(
            {
                ...
                callbackURL: "https://sevalink-backend-76zq.onrender.com/api/auth/google/callback",
            },
    ...
    console.warn("Passport: Google OAuth credentials missing. Google login will not be available.");
}
